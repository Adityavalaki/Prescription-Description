...
export default function ScanScreen({ navigation }) {
  ...
  const corner = (x, y) => ({
    ...
    borderLeftWidth: x ? 0 : 3, borderRightWidth: x ? 3 : 0, borderColor: '#fff', borderRadius: 4,
  });
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#14110F' }}>
      ...
      <View pointerEvents="none" style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, alignItems: 'center', justifyContent: 'center' }}>
        ...
        <Text style={{ position: 'absolute', bottom: 150, color: 'rgba(255,255,255,0.85)', fontSize: 13, fontFamily: F.uiMed }}>Position the prescription inside the frame</Text>
      </View>

      {/* manual entry shortcut */}
      <Pressable onPress={() => navigation.navigate('ManualEntry')} style={{ position: 'absolute', bottom: insets.bottom + 118, alignSelf: 'center', flexDirection: 'row', alignItems: 'center', gap: 7, height: 38, paddingHorizontal: 16, borderRadius: 99, backgroundColor: 'rgba(0,0,0,0.45)' }}>
