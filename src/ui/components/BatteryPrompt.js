// components/BatteryPrompt.js — one-time prompt to exempt Medira from battery optimisation,
      ...
      <View style={{ flex: 1, backgroundColor: 'rgba(20,17,15,0.5)', justifyContent: 'center', paddingHorizontal: 24, paddingBottom: insets.bottom }}>
        <View style={{ backgroundColor: C.paper, borderRadius: 24, padding: 24 }}>
          ...
          <Text style={{ fontSize: 15.5, lineHeight: 23, color: C.inkSoft, marginTop: 10, fontFamily: F.ui }}>
            To make sure your medicine alarms ring exactly when they should — even while your phone is asleep — please allow Medira to run without battery limits.
          </Text>
          <Text style={{ fontSize: 14, lineHeight: 21, color: C.inkFaint, marginTop: 10, fontFamily: F.ui }}>
            On the next screen, choose <Text style={{ fontFamily: F.uiBold, color: C.ink }}>Don't optimize</Text> (or <Text style={{ fontFamily: F.uiBold, color: C.ink }}>Allow / No restrictions</Text>) for Medira.
          </Text>
