# Medira — Google Play launch pack
...
> Medira is a medication-reminder app. Its core function is to alert users to take their
...
Medira requires sign-in. Tell reviewers how to get in without Google:
...
**Full description:**
```
Medira turns a photo of your prescription into a clear medicine plan — and reminds you to take every dose on time.

SCAN INSTEAD OF TYPING
Point your camera at a handwritten or printed prescription. Medira reads the medicine names, strengths, dose timing (morning–afternoon–night), and course length, then lets you review and fix anything before saving.
...
Reminders are set around your meal times (e.g. after food). Scan later in the day? Medira only schedules the doses still ahead, so your plan always makes sense.

STAY ON TOP OF REFILLS
Medira tracks when a course runs out and reminds you to see your doctor for a repeat prescription — and can add it to your calendar.
...
Medira is a reminder and organisation tool, not a medical device, and does not give medical advice. Always follow your doctor and pharmacist, and check every medicine and dose. Don’t rely on Medira alone for critical medication.
```
