# Medira — React Native + Expo (JavaScript)

A React Native / Expo port of the **Medira** prescription-detection prototype:
...
- The original web prototype is unchanged — see
  `Medira - Prescription Detection.html` at the project root.
```
